...
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\n__webpack_require__(/*! ../src/style.css */ \"./src/style.css\");\nconst forecast_1 = __webpack_require__(/*! ./forecast */ \"./script/forecast.js\");\nconst weather_1 = __webpack_require__(/*! ./weather */ \"./script/weather.js\");\nconst cityInput = document.getElementById('city-form');\nconst search = document.getElementById('city-search');\nconst inputError = document.getElementById('search-error');\nconst weatherContainer = document.getElementById('weather');\nconst forecastContainer = document.getElementById('forecast');\n(0, weather_1.updateWeather)('London');\n(0, forecast_1.updateForcast)('London');\nfunction fadeIn(element) {\n    element.classList.remove('fade');\n    element.style.display = 'none';\n    element.offsetHeight;\n    element.style.display = 'flex';\n    element.classList.add('fade');\n}\n;\ncityInput.addEventListener('submit', (e) => __awaiter(void 0, void 0, void 0, function* () {\n    e.preventDefault();\n    if (cityInput.checkValidity()) {\n        try {\n            let city = search.value;\n            yield (0, weather_1.updateWeather)(city);\n            yield (0, forecast_1.updateForcast)(city);\n            hideError();\n            fadeIn(weatherContainer);\n            fadeIn(forecastContainer);\n        }\n        catch (_a) {\n            displayError();\n        }\n    }\n    else\n        displayError();\n}));\nfunction displayError() {\n    fadeIn(inputError);\n    if (search.validity.valueMissing)\n        inputError.textContent = 'Empty city name';\n    else\n        inputError.textContent = 'Invalid city name';\n}\n;\nfunction hideError() {\n    inputError.textContent = '';\n    inputError.style.display = 'none';\n}\n;\n\n\n//# sourceURL=webpack://weather-app/./script/index.js?");
...
eval("module.exports = __webpack_require__.p + \"5e19f05c9f5dab094c8b.ttf\";\n\n//# sourceURL=webpack://weather-app/./assets/FredokaOne-Regular.ttf?");

/***/ }),

/***/ "./assets/Share-Regular.ttf":
/*!**********************************!*\
  !*** ./assets/Share-Regular.ttf ***!
  \**********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"380ba4337f16f81374cd.ttf\";\n\n//# sourceURL=webpack://weather-app/./assets/Share-Regular.ttf?");
...
eval("module.exports = __webpack_require__.p + \"6d582c84c68f1ca3b47d.jpg\";\n\n//# sourceURL=webpack://weather-app/./assets/night.jpg?");
